...
<section className="bg-[#f7f4ee] py-32">
  ...
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="grid gap-6 lg:grid-cols-12">
      ...
      {/* Bottom Left Small */}
      <div className="rounded-[28px] bg-[#efe8d8] p-10 lg:col-span-3">
        ...
        <h3 className="mt-2 font-serif text-2xl text-[#123524]">
          Phytochemical R&D
        </h3>
      ...
      <div className="group relative overflow-hidden rounded-[28px] lg:col-span-9">
        ...
        <Image
          ...
          width={1400}
          height={800}
          className="h-[260px] w-full object-cover transition duration-1000 group-hover:scale-105"
        />
      ...
      <div>
        ...
        <div className="mt-12 space-y-10">
          ...
          <div className="flex gap-5">
            ...
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#123524]/10">
              <Warehouse
                size={24}
                className="text-[#123524]"
              />
